...
public class GridRankingSemanal extends RecyclerView.Adapter<GridRankingSemanal.ViewHolder>{
    ...
    public GridRankingSemanal(List<RankingItemNavigation> ofertainfo, String id) {
        super();
